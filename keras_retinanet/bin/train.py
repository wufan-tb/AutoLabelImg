...
def parse_args(args):
    ...
    group.add_argument('--weights',           help='Initialize the model with weights from a file.',default='D:/Learning/keras-retinanet-master/snapshots/ResNet-50-model.keras.h5')
    ...
    parser.add_argument('--tensorboard-dir',  help='Log directory for Tensorboard output', default='./tensorboard')# default='./logs')
